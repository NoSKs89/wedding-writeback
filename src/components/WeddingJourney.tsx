...
// import { springConfigPresets, weddingColorSchemes } from '../config/levaPresets';
...
//     return (experienceSettings?.timelineLength > 0 && windowHeight > 0 ? experienceSettings.timelineLength / windowHeight : 3) + 1;
//   }, [experienceSettings]);
